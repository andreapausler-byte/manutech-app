...
- **Prossimo step**: da decidere a freddo — l'Agenda settimanale richiesta era l'unica voce in coda ed è stata consegnata. Candidati realistici: (a) **Interventi v2 / ADR-008** — chiudere Open Q residue (#2 notifica operatore linea, #4 reschedulazione, #5 storico) con confronto manutentore #2, poi pivotare ADR-008 a `accepted` e creare sprint dedicato. Blocca Agenda tecnico mobile di FASE 3. (b) **Test live agenda lista** in produzione, annotare frizioni reali dopo 5 PR in un giorno prima di muoversi. (c) **Fase 1 events** rinviata il 9/5 — fondamento architetturale di lungo periodo, sprint lungo, alto ROI. (d) **Polish UX residuo mobile** intercettato da (b). Test #1 push severità critica (admin push `new_report_critical`) ancora rinviato — non bloccante.
