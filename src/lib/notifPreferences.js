...
export const NOTIF_TYPES = [
  ...
  { key: 'new_report_critical',   label: 'Segnalazione critica',           icon: '🚨', group: 'segnalazioni' },
  ...
  { key: 'intervention_assigned',         label: 'Intervento assegnato a me',       icon: '🛠️', group: 'interventi' },
  { key: 'intervention_rescheduled',      label: 'Intervento riprogrammato',        icon: '📅', group: 'interventi' },
  { key: 'intervention_scheduled_change', label: 'Cambio data (sono coinvolto)',    icon: '🗓️', group: 'interventi' },
  { key: 'intervention_cancelled',        label: 'Intervento annullato',            icon: '🚫', group: 'interventi' },
  { key: 'intervention_status_change',    label: 'Avanzamento intervento',          icon: '📈', group: 'interventi' },
  { key: 'participant_added',             label: 'Aggiunto come coinvolto',         icon: '➕', group: 'interventi' },
  { key: 'participant_removed',           label: 'Rimosso da un intervento',        icon: '➖', group: 'interventi' },
...
// Push: specchio dei ROLE_DEFAULTS in send-push-notification/index.ts.
// Email: specchio degli EMAIL_ROLE_DEFAULTS in send-email-notification/index.ts
// — canale "deve arrivare comunque", ON solo per gli eventi che cambiano
// il lavoro di qualcuno; il rumore di avanzamento resta su push/in-app.
export const ROLE_DEFAULTS = {
  admin: {
    new_report: true,
    new_report_critical: true,
    quick_report: true,
    assigned: true,
    status_change: true,
    comment: true,
    intervention_assigned: true,
    intervention_rescheduled: true,
    intervention_scheduled_change: true,
    intervention_cancelled: true,
    intervention_status_change: true,
  ...
  operatore: {
    new_report: false,
    new_report_critical: false,
    quick_report: false,
    assigned: true,
    status_change: true,
    comment: true,
    intervention_assigned: false,
    intervention_rescheduled: false,
    intervention_scheduled_change: true,
